...
<nav>
    ...
    <a id="nav_logo" class="d-b" href="{{ route('home') }}"><img class="fit_img" src="{{ asset('img/logo.png') }}" alt="logo"></a>
    <div class="nav_admin">
...
<aside>
    <div id="aside_logo">
        <a class="d-b" href="#"><img class="fit_img" src="{{ asset('img/logo.png') }}" alt="logo"></a>
    </div>
    <div id="aside_admin">
